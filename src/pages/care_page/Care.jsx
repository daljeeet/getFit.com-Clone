...
const Care = () => {
  ...
  const getData = async () => {
    axios
      .get("https://mercury-breezy-cave.glitch.me/lab_tests")
  ...
  const faqs = [
    ...
    {
      q: "If I buy the cultpass Home on one device, can I use it on another device?",
      a: "Yes, if you login with your same credentials, you can use cultpass Home on other devices. However, you can not stream a class at the same time on more than one device.",
    },
    {
      q: "What are the different options available with cultpass Home?",
      a: "cultpass Home gives you full access to at home and on-demand content on the app/website. We have options of different durations available, you can check the latest offers and prices on the app/website by clicking on the 'At home' tab, and then clicking on the 'Become a member' option.  ",
    },
    {
      q: "What are the services accessible to a cultpass Home member?",
      a: "cultpass Home gives you unlimited access to all Digital At home classes and DIY (on demand) sessions across. This includes unlimited access to fitness, dance, meditation, cooking and health video content and podcasts. A member has an all access pass to celebrity masterclasses, ability to workout with friends and track their energy scores, and monitor their progress in the form of reports.  cultpass Home does not include online therapy consultations as well as non digital offerings of cult.fit.",
    },
    {
      q: "Can I cancel cultpass Home subscription after purchase?",
      a: "An already purchased subscription can not be canceled. However, if you’re facing issues with your subscription, you can reach out to customer support to try and fix the same. If your subscription is an auto-renewing subscription, you can always cancel future renewals from the App Store and the amount will not be deducted in the upcoming billing cycle. ",
    },
    {
      q: "Can I transfer or pause cultpass Home?",
      a: "You cannot pause or transfer your cultpass Home subscription.",
    },
    {
      q: "What services does the cultpass Home not include?",
      a: "cultpass Home does not include therapy consultations as well as non digital offerings of cult.fit.",
    },
    {
      q: "What are At-Home Classes?",
      a: "At-home classes let you experience the energy of a group fitness class, led by star trainers from the comfort of your home. We currently offer At- classes across fitness formats like Cardio, HRX, Strength & Conditioning, and Yoga across all 7 days of the week. To make the most of these classes, we recommend using the Energy Meter feature that will give real-time feedback on your workout and help you compete with others working out with you.",
    },
    {
      q: "I’m new to working out, are At-home classes safe for beginners like me?",
      a: "At-home classes are tagged basis levels - beginner, intermediate and advanced. In case you are suffering through an injury, chronic pain or medical condition, we recommend checking with a medical expert before attending At-home classes. ",
    },
    {
      q: "Do I need equipment to attend At-home Classes?",
      a: "Most of the classes feature bodyweight workouts which means you won’t need equipment or free weights.",
    },
    {
      q: "What are the types of workouts featured in At-home classes?",
      a: "Most of our workouts are no-equipment routines across fitness formats like strength, cardio, yoga, HRX and more. We recommend you wear comfortable shoes and keep a napkin and water bottle handy.",
    },
    {
      q: "Can I download a At-home class that I’ve subscribed to in advance?",
      a: "All our classes are streamed LIVE - which means you can only access them at a scheduled time over good network connectivity.",
    },
  ];
  if (loading) {
    return <Loader />;
    ...
    return (
      <>
        ...
        <Box pt="10" w="85%" m="auto">
          ...
          <Grid
            templateColumns={{md:"repeat(5, 1fr)",sm:"repeat(2,1fr)",base:"repeat(1,1fr)"}}
            templateRows="auto"
            my="8"
            rowGap="10"
            columnGap="4"
          >
            {data.map((el) => (
              <Box key={el.id} cursor="pointer" shadow='base'p='2' _hover={{shadow:'lg'}} >
                <Image src={el.src} />
                <Box display="flex" justifyContent="space-between">
                  ...
                  <Box>
                    <Text decoration="line-through" fontSize="sm">
                      {el.orgPrice}
                    </Text>
        ...
        <Box bg="gray.900" color="gray.300" py="10">
          <Faqs faqs={faqs} />
          <Box bg="gray.100" pt="6">
            <Heading color="gray.800" fontSize="6xl" my="4">
              THE BEST
            </Heading>
            <Heading color="gray.600" my="4">
              DOCTOR GIVES
            </Heading>
            <Heading color="gray.300">THE LEAST MEDICINE</Heading>
          </Box>
          <Footer />
        </Box>
